...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-2 pb-2 mb-4 border-bottom border-light-subtle">
        <div>
            <h1 class="h2 fw-bold text-dark m-0">CRUD CATEGORÍAS</h1>
                ...
                <tbody class="small text-dark">
                    <tr>
                        ...
                        <td class="fw-bold text-dark">
                            <i class="bi bi-film me-2 text-success"></i>Películas
                        </td>
                        <td class="text-muted">Proyecciones cinematográficas, dramas, acción y estrenos de cine.</td>
                    ...
                    <tr>
                        ...
                        <td class="fw-bold text-dark">
                            <i class="bi bi-music-note-beamed me-2 text-success"></i>Conciertos
                        </td>
                        <td class="text-muted">Presentaciones musicales en vivo, festivales y recitales de bandas.</td>
                        <td><span class="text-success fw-bold">Activo</span></td>
                        <td class="text-end">
                            <div class="btn-group shadow-sm rounded-pill">
